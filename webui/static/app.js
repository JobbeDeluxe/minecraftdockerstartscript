...
Object.assign(I18N.de, {
  "app.subtitle": "Server, Konsole und Automatisierung",
  ...
  "overview.openManagement": "Management öffnen",
  "overview.nextSteps": "Schnellzugriff",
  "overview.managementHint": "Starten, stoppen, Logs und RCON",
  "overview.settingsHint": "Profil, Plugins, Dateien und Backups",
  "overview.automationHint": "Zeitpläne für alle oder einzelne Server",
  "overview.state": "Status",
  "overview.players": "Spieler",
  "overview.version": "Version",
  "overview.nextRun": "Nächster Zeitplan",
  "overview.noSchedule": "Keiner",
  "create.title": "Neues Serverprofil",
  "create.intro": "Die wichtigsten Angaben zuerst. Weitere Optionen kannst du danach unter Einstellungen ändern.",
  "create.generatePassword": "Generieren",
  "create.submit": "Serverprofil erstellen",
  "create.cancel": "Abbrechen",
  "settings.profile": "Serverprofil bearbeiten",
  "settings.intro": "Profilwerte, Netzwerk, Backups, Plugins und Dateien.",
  "settings.danger": "Gefahrenbereich",
  "management.intro": "Laufzeit, Spieler, Live-Logs und beliebige RCON-Befehle.",
  "management.logs": "Server-Logs",
  "management.logsHint": "Die letzten Container-Logs, optional automatisch aktualisiert.",
  "rcon.hint": "Jeder Minecraft-Befehl ist möglich, mit oder ohne führenden /.",
  "rcon.clear": "Leeren",
  "rcon.ready": "RCON bereit. Beispiele: whitelist on, whitelist add Spieler, op Spieler",
  "automation.title": "Zeitpläne",
  "automation.intro": "Aktionen laufen serverseitig – auch wenn diese Seite geschlossen ist. Verwendet wird die lokale Zeit des Hosts.",
  "automation.new": "Neuer Zeitplan",
  "automation.edit": "Zeitplan bearbeiten",
  "automation.name": "Name",
  "automation.target": "Ziel",
  "automation.action": "Aktion",
  "automation.time": "Uhrzeit",
  "automation.state": "Status",
  "automation.enabled": "Aktiv",
  "automation.command": "RCON-Befehl",
  "automation.days": "Wochentage",
  "automation.save": "Zeitplan speichern",
  "automation.run": "Jetzt ausführen",
  "automation.delete": "Löschen",
  "automation.lastResult": "Letztes Ergebnis",
  "automation.neverRun": "Noch nicht ausgeführt.",
  "automation.allServers": "Alle aktiven Server",
  "automation.daily": "Täglich",
  "automation.noSchedules": "Noch keine Zeitpläne angelegt.",
  "automation.restart": "Server neu starten",
  "automation.pluginsRestart": "Plugins aktualisieren + Neustart",
  "automation.backup": "Backup erstellen",
  "automation.plugins": "Plugins aktualisieren",
  "automation.start": "Server starten",
  "automation.stop": "Server stoppen",
  "automation.rcon": "RCON-Befehl senden",
  "automation.saved": "Zeitplan gespeichert.",
  "automation.started": "Zeitplan wurde gestartet.",
  "automation.confirmDelete": "Diesen Zeitplan wirklich löschen?",
  "automation.status.active": "aktiv",
  "automation.status.disabled": "pausiert",
...
Object.assign(I18N.en, {
  "app.subtitle": "Servers, console and automation",
  ...
  "overview.openManagement": "Open management",
  "overview.nextSteps": "Quick access",
  "overview.managementHint": "Start, stop, logs and RCON",
  "overview.settingsHint": "Profile, plugins, files and backups",
  "overview.automationHint": "Schedules for all or individual servers",
  "overview.state": "Status",
  "overview.players": "Players",
  "overview.version": "Version",
  "overview.nextRun": "Next schedule",
  "overview.noSchedule": "None",
  "create.title": "New server profile",
  "create.intro": "Start with the essentials. Additional options remain available under Settings.",
  "create.generatePassword": "Generate",
  "create.submit": "Create server profile",
  "create.cancel": "Cancel",
  "settings.profile": "Edit server profile",
  "settings.intro": "Profile values, network, backups, plugins and files.",
  "settings.danger": "Danger zone",
  "management.intro": "Runtime, players, live logs and arbitrary RCON commands.",
  "management.logs": "Server logs",
  "management.logsHint": "Recent container logs, with optional automatic refresh.",
  "rcon.hint": "Any Minecraft command works, with or without a leading slash.",
  "rcon.clear": "Clear",
  "rcon.ready": "RCON ready. Examples: whitelist on, whitelist add Player, op Player",
  "automation.title": "Schedules",
  "automation.intro": "Actions run on the server even when this page is closed. The host's local time is used.",
  "automation.new": "New schedule",
  "automation.edit": "Edit schedule",
  "automation.name": "Name",
  ...
  "automation.command": "RCON command",
  "automation.days": "Weekdays",
  "automation.save": "Save schedule",
  "automation.run": "Run now",
  "automation.delete": "Delete",
  "automation.lastResult": "Last result",
  "automation.neverRun": "Not run yet.",
  "automation.allServers": "All active servers",
  "automation.daily": "Daily",
  "automation.noSchedules": "No schedules created yet.",
  "automation.restart": "Restart server",
  "automation.pluginsRestart": "Update plugins + restart",
  "automation.backup": "Create backup",
  "automation.plugins": "Update plugins",
  "automation.start": "Start server",
  "automation.stop": "Stop server",
  "automation.rcon": "Send RCON command",
  "automation.saved": "Schedule saved.",
  "automation.started": "Schedule started.",
  "automation.confirmDelete": "Really delete this schedule?",
  "automation.status.active": "active",
  "automation.status.disabled": "paused",
...
Neue Bereiche
Uebersicht zeigt Status, Ports und Schnellzugriffe. Server erstellen enthaelt nur die wichtigsten Startfelder. Einstellungen buendelt Profil, Backups, Plugins und Dateien. Management enthaelt Laufzeitaktionen, Spieler, Live-Logs und die freie RCON-Konsole. Automatisierung verwaltet serverseitige Zeitplaene.

Freie RCON-Konsole
Im Management kann jeder Minecraft-Befehl direkt eingegeben werden, zum Beispiel whitelist on, whitelist add Spieler, op Spieler, deop Spieler oder gamerule keepInventory true. Ein fuehrender Schraegstrich ist optional. Pfeil hoch und runter durchsuchen den Befehlsverlauf.

Automatisierung
Zeitplaene koennen einen Server oder alle aktiven Server steuern. Verfuegbar sind Start, Stop, Restart, Backup, Plugin-Update, Plugin-Update mit Restart und freie RCON-Befehle. Die lokale Uhrzeit des Hosts gilt; die WebUI muss laufen, der Browser darf geschlossen sein.`;
I18N.en["help.text"] += `

New sections
Overview shows status, ports and shortcuts. Create server contains the essential starting fields. Settings groups the profile, backups, plugins and files. Management contains runtime actions, players, live logs and the free-form RCON console. Automation manages server-side schedules.

Free-form RCON console
Management accepts any Minecraft command, for example whitelist on, whitelist add Player, op Player, deop Player or gamerule keepInventory true. A leading slash is optional. Use the up and down arrow keys to browse command history.

Automation
Schedules can target one server or all active servers. Available actions are start, stop, restart, backup, plugin updates, plugin update with restart and arbitrary RCON commands. The host's local time is used; the WebUI must be running, but the browser can be closed.`;
...
function applyLanguageStatic() {
  ...
  if ($("liveLogs")) $("liveLogs").textContent = t(liveTimer ? "button.stopLive" : "button.liveLogs");
  ...
  if ($("rconCommand")) $("rconCommand").placeholder = lang === "de" ? "whitelist add Spieler / op Spieler" : "whitelist add Player / op Player";
...
function showView(name, updateHash = true) {
  const known = new Set(["overview", "create", "settings", "management", "automation"]);
  if (!known.has(name)) name = "overview";
  if (!selected && ["overview", "settings", "management"].includes(name)) name = "create";
  activeView = name;
  ...
  if (name === "automation") loadSchedules().catch(error => showOutput(error.message));
...
function renderOverview() {
  ...
  const status = server.status || {};
  const disabled = currentDisabled();
  if ($("overviewServerName")) $("overviewServerName").textContent = server.name || server.id || (lang === "de" ? "Kein Server ausgewählt" : "No server selected");
  if ($("managementServerName")) $("managementServerName").textContent = server.name || server.id || t("nav.management");
  if ($("overviewServerMeta")) $("overviewServerMeta").textContent = server.id ? `${server.container_name || "–"} · ${server.type || "–"} · :${server.host_port || "–"}` : "";
  const cards = $("overviewCards");
  if (!cards) return;
  cards.innerHTML = "";
  const player = server.players || {};
  const schedule = schedules.find(item => item.enabled && (item.target === "all" || item.target === server.id));
  const values = [
    [t("overview.state"), displayState(status.state, disabled), status.running && !disabled ? "good" : "bad"],
    [t("overview.players"), player.max ? `${player.online ?? 0} / ${player.max}` : String(player.online ?? "–"), ""],
    [t("overview.version"), `${server.type || "–"} ${server.version || ""}`.trim(), ""],
    [t("overview.nextRun"), schedule ? `${schedule.time} · ${schedule.name}` : t("overview.noSchedule"), ""]
  ];
  for (const [label, value, cls] of values) cards.append(el("div", { class: `status-card ${cls}`.trim() }, [el("span", { text: label }), el("strong", { text: value })]));
}
...
function nextFreePort(start, key) {
  const used = new Set(servers.map(server => Number(server[key])).filter(Number.isFinite));
  let port = start;
...
function resetCreateForm() {
  ...
  for (const type of serverTypes) $("createType").append(el("option", { value: type, text: type }));
  $("createType").value = "PAPER";
  $("createVersion").value = "LATEST";
  $("createMemory").value = "6G";
  $("createHostPort").value = nextFreePort(25565, "host_port");
  $("createRconPort").value = nextFreePort(25575, "rcon_host_port");
  $("createRconPassword").value = createPassword();
  $("createRcon").checked = true;
  $("createEula").checked = false;
  $("createId").dataset.manual = "";
}
$("newServer").onclick = () => { resetCreateForm(); showView("create"); };
$("generateRconPassword").onclick = () => { $("createRconPassword").value = createPassword(); };
$("createRcon").onchange = () => { $("createRconPassword").required = $("createRcon").checked; };
$("createName").oninput = () => {
  if ($("createId").dataset.manual) return;
  const id = $("createName").value.trim().toLowerCase().replace(/[^a-z0-9_.-]+/g, "-").replace(/^[-_.]+|[-_.]+$/g, "");
  $("createId").value = id;
  $("createContainer").value = id ? `mc-${id}` : "";
  $("createDataDir").value = id ? `/opt/minecraft/${id}` : "";
};
$("createId").oninput = () => { $("createId").dataset.manual = "1"; };
$("createServerForm").onsubmit = async event => {
  event.preventDefault();
  ...
  const data = {
    ...
    container_name: $("createContainer").value.trim(),
    data_dir: $("createDataDir").value.trim(),
    memory: $("createMemory").value.trim(),
    type,
    version: $("createVersion").value.trim() || "LATEST",
    paper_channel: "default",
    host_port: $("createHostPort").value.trim(),
    docker_image: proxyTypes.has(type) ? "itzg/mc-proxy" : "itzg/minecraft-server",
    eula_accepted: $("createEula").checked,
    rcon_enabled: $("createRcon").checked,
    rcon_password: $("createRconPassword").value,
    rcon_host_port: $("createRconPort").value.trim(),
    rcon_container_port: "25575",
    start_after_apply: true
  };
  try {
    const saved = await api("/api/servers", { method: "POST", body: JSON.stringify(data) });
    selected = saved.id;
    setConfigDirty(false);
    await loadServers();
    showOutput(lang === "de" ? "Serverprofil erstellt. Du kannst es jetzt im Management anwenden und starten." : "Server profile created. You can now apply and start it from Management.");
    showView("settings");
  } catch (err) {
    showOutput(err.message);
  }
...
function appendRcon(command, result = null, error = null) {
  const consoleBox = $("rconOutput");
  const stamp = new Date().toLocaleTimeString([], { hour: "2-digit", minute: "2-digit", second: "2-digit" });
  const output = error || [result?.stdout, result?.stderr].filter(Boolean).join("\n").trim() || (result?.ok ? "OK" : "Keine Antwort");
  const entry = `[${stamp}] > ${command}\n${output}`;
  consoleBox.textContent = consoleBox.textContent.trim() ? `${consoleBox.textContent.trim()}\n\n${entry}` : entry;
  consoleBox.scrollTop = consoleBox.scrollHeight;
}
async function sendRconCommand(rawCommand) {
  const command = String(rawCommand || "").trim();
  if (!command || !selected) return;
  rconHistory.push(command);
  rconHistoryIndex = rconHistory.length;
  $("rconCommand").value = "";
  appendRcon(command, { ok: true, stdout: lang === "de" ? "Wird gesendet …" : "Sending …" });
  try {
    const result = await api(`/api/servers/${selected}/rcon`, { method: "POST", body: JSON.stringify({ command }) });
    const box = $("rconOutput");
    const lines = box.textContent.split("\n\n");
    lines.pop();
    box.textContent = lines.join("\n\n");
    appendRcon(command, result);
    if (!result.ok) showOutput(`${t("message.error")}: ${result.stderr || result.stdout || command}`);
    return result;
  } catch (err) {
    const box = $("rconOutput");
    const lines = box.textContent.split("\n\n");
    lines.pop();
    box.textContent = lines.join("\n\n");
    appendRcon(command, null, err.message);
    showOutput(err.message);
    return null;
  }
}
$("rconForm").onsubmit = async event => {
  event.preventDefault();
  await sendRconCommand($("rconCommand").value);
};
$("rconCommand").onkeydown = event => {
  if (event.key === "ArrowUp" && rconHistory.length) {
    event.preventDefault();
    rconHistoryIndex = Math.max(0, rconHistoryIndex - 1);
    event.currentTarget.value = rconHistory[rconHistoryIndex] || "";
  } else if (event.key === "ArrowDown" && rconHistory.length) {
    event.preventDefault();
    rconHistoryIndex = Math.min(rconHistory.length, rconHistoryIndex + 1);
    event.currentTarget.value = rconHistory[rconHistoryIndex] || "";
  }
};
document.querySelectorAll("[data-rcon-template]").forEach(button => {
  button.onclick = () => { $("rconCommand").value = button.dataset.rconTemplate; $("rconCommand").focus(); $("rconCommand").setSelectionRange($("rconCommand").value.length, $("rconCommand").value.length); };
});
$("clearRcon").onclick = () => { $("rconOutput").textContent = t("rcon.ready"); };
...
const scheduleActionKeys = {
  restart: "automation.restart",
  "plugins-restart": "automation.pluginsRestart",
  backup: "automation.backup",
  plugins: "automation.plugins",
  start: "automation.start",
  stop: "automation.stop",
  rcon: "automation.rcon"
};
function renderScheduleActionOptions() {
  const select = $("scheduleAction");
  if (!select) return;
  for (const option of select.options) option.textContent = t(scheduleActionKeys[option.value] || option.value);
}
function renderScheduleTargets() {
  ...
  select.innerHTML = "";
  select.append(el("option", { value: "all", text: t("automation.allServers") }));
  for (const server of servers) select.append(el("option", { value: server.id, text: server.name || server.id }));
  select.value = [...select.options].some(option => option.value === value) ? value : "all";
}
function scheduleDaysText(days) {
  if ((days || []).length === 7) return t("automation.daily");
  const labels = lang === "de" ? ["Mo", "Di", "Mi", "Do", "Fr", "Sa", "So"] : ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"];
...
function renderSchedules() {
  ...
  box.innerHTML = "";
  if (!schedules.length) {
    box.append(el("div", { class: "box muted", text: t("automation.noSchedules") }));
    return;
  }
  for (const schedule of schedules) {
    const target = schedule.target === "all" ? t("automation.allServers") : (servers.find(server => server.id === schedule.target)?.name || schedule.target);
    const state = schedule.running ? "running" : (schedule.last_status || (schedule.enabled ? "active" : "disabled"));
    const button = el("button", { type: "button", class: `schedule-card${selectedSchedule === schedule.id ? " active" : ""}` }, [
      el("span", {}, [el("strong", { text: schedule.name }), el("span", { class: "schedule-meta", text: `${schedule.time} · ${scheduleDaysText(schedule.days)}\n${t(scheduleActionKeys[schedule.action] || schedule.action)} · ${target}` })]),
      el("span", { class: `schedule-state ${state}`, text: t(`automation.status.${state}`) })
    ]);
...
async function loadSchedules() {
  ...
  if (selectedSchedule && !schedules.some(item => item.id === selectedSchedule)) selectedSchedule = null;
  renderSchedules();
  renderOverview();
  if (selectedSchedule) {
    const schedule = schedules.find(item => item.id === selectedSchedule);
    if (schedule) $("scheduleResult").textContent = schedule.last_result || t("automation.neverRun");
  }
}
function resetScheduleForm() {
  ...
  $("scheduleAction").value = "restart";
  $("scheduleTarget").value = "all";
  $("scheduleCommandRow").hidden = true;
  $("scheduleFormTitle").textContent = t("automation.new");
  $("scheduleResult").textContent = t("automation.neverRun");
  $("runSchedule").disabled = true;
...
function editSchedule(scheduleId) {
  ...
  $("scheduleTarget").value = schedule.target || "all";
  $("scheduleAction").value = schedule.action || "restart";
  $("scheduleTime").value = schedule.time || "03:00";
  $("scheduleEnabled").checked = schedule.enabled !== false;
  $("scheduleCommand").value = schedule.command || "";
  $("scheduleCommandRow").hidden = schedule.action !== "rcon";
  $("scheduleDays").querySelectorAll("input").forEach(input => { input.checked = (schedule.days || []).includes(Number(input.value)); });
  $("scheduleFormTitle").textContent = t("automation.edit");
  $("scheduleResult").textContent = schedule.last_result || t("automation.neverRun");
  $("runSchedule").disabled = !!schedule.running;
  $("deleteSchedule").disabled = !!schedule.running;
  renderSchedules();
}
$("scheduleAction").onchange = () => { $("scheduleCommandRow").hidden = $("scheduleAction").value !== "rcon"; };
$("newSchedule").onclick = () => resetScheduleForm();
$("scheduleForm").onsubmit = async event => {
  event.preventDefault();
  const payload = {
    id: $("scheduleId").value || undefined,
    name: $("scheduleName").value.trim(),
    target: $("scheduleTarget").value,
    action: $("scheduleAction").value,
    time: $("scheduleTime").value,
    enabled: $("scheduleEnabled").checked,
    command: $("scheduleCommand").value.trim(),
    days: [...$("scheduleDays").querySelectorAll("input:checked")].map(input => Number(input.value))
  };
  try {
    const saved = await api("/api/schedules", { method: "POST", body: JSON.stringify(payload) });
    selectedSchedule = saved.id;
    await loadSchedules();
    editSchedule(saved.id);
    showOutput(t("automation.saved"));
  } catch (err) {
    showOutput(err.message);
  }
};
$("runSchedule").onclick = async () => {
  if (!selectedSchedule) return;
  try {
    await api(`/api/schedules/${selectedSchedule}/run`, { method: "POST", body: "{}" });
    showOutput(t("automation.started"));
    await loadSchedules();
    editSchedule(selectedSchedule);
    setTimeout(() => loadSchedules().then(() => selectedSchedule && editSchedule(selectedSchedule)).catch(() => {}), 2500);
  } catch (err) {
    showOutput(err.message);
  }
};
$("deleteSchedule").onclick = async () => {
  if (!selectedSchedule || !confirm(t("automation.confirmDelete"))) return;
  try {
    await api(`/api/schedules/${selectedSchedule}`, { method: "DELETE" });
    resetScheduleForm();
    await loadSchedules();
  } catch (err) {
    showOutput(err.message);
...
$("clearActivity").onclick = () => showOutput("");
window.addEventListener("hashchange", () => showView(window.location.hash.slice(1), false));
resetCreateForm();
renderScheduleTargets();
resetScheduleForm();
applyLanguageStatic();
$("rconOutput").textContent = t("rcon.ready");
const initialView = window.location.hash.slice(1) || "overview";
loadServers().then(() => showView(initialView, false)).catch(error => $("result").textContent = error.message);
